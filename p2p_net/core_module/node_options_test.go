...
func TestNodeOptions(t *testing.T) {
	...
	f := func(publicKey cryptographic.PublicKey, host net.IP, port uint16) bool {
		id := cryptographic.NewID(publicKey, host, port)
	...
	g := func(privateKey cryptographic.PrivateKey) bool {
