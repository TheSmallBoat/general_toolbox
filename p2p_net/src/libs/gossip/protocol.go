// Package gossip is a simple implementation of a gossip protocol for this package. It keeps track of a cache of messages
...
func (p *Protocol) hash(id cryptographic.ID, data []byte) []byte {
	return append(id.PubKey[:], data...)
}
