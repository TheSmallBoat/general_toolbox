...
func (ctx *HandlerContext) ID() cryptographic.ID {
...
// otherwise.
//
// It is highly recommended that should you choose to have your application utilize package's serialization/
...
func (ctx *HandlerContext) DecodeMessage() (common.Serializable, error) {
...
// on.
//
// It is highly recommended that should you choose to have your application utilize package's
...
func (ctx *HandlerContext) SendMessage(msg common.Serializable) error {
